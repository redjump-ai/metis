...
class URLDatabase:
    ...
    def _find_url_file(self, url: str) -> Path | None:
    ...
    def update_status(self, url: str, status: str, folder_path: str | None = None):
    ...
    def get_url(self, url: str) -> dict | None:
    ...
    def get_all_urls(self, status: str | None = None) -> list[dict]:
